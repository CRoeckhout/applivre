    ...
    <SafeAreaView className="flex-1 bg-paper">
      <KeyboardAvoidingView
        ...
        <View className="flex-1 justify-center px-8">
          ...
          <Animated.View entering={FadeIn.duration(400).delay(120)} className="mt-8">
            ...
            <View className="flex-row items-center gap-3 rounded-2xl bg-paper-warm px-5 py-3">
              ...
              {!isFetching && !error && value.length >= 3 && available === true && (
          ...
          <Pressable onPress={() => signOut()} className="mt-6 py-2 active:opacity-70">
